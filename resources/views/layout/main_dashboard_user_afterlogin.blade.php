...
<body>
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <!-- Help-->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="mdi mdi-help font-24"></i>
                                ...
                                <ul class="list-style-none">
                                    <li>
                                        <div class="drop-title bg-primary text-white">
                                            <h4 class="mb-0 mt-1">Help</h4>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="message-center help">
                                            <!-- FAQ -->
                                            <a href="javascript:void(0)" class="message-item">
                                                <span class="btn btn-warning btn-circle"><i class="fa fa-question"></i></span>
                                                <div class="mail-contnet">
                                                    <h5 class="message-title">FAQ</h5> <span class="mail-desc">Frequently Asked Questions</span></div>
                                            </a>
                                            <!-- Contact Support -->
                                            <a href="javascript:void(0)" class="message-item">
                                                <span class="btn btn-success btn-circle"><i class="fa fa-phone"></i></span>
                                                <div class="mail-contnet">
                                                    <h5 class="message-title">Contact Us</h5> <span class="mail-desc">Contact us if you have some question or anything else</span> 
                                                </div>
                                            </a>
                                        </div>
                                    </li>
                                ...
                                <ul class="list-style-none">
                                    ...
                                    <li>
                                        <div class="message-center message-body">
                                            ...
                                            <!-- Message -->
                                            <a href="javascript:void(0)" class="message-item">
                                                <span class="user-img"> <img src="dashboard/assets/images/users/2.jpg" alt="user" class="rounded-circle"> <span class="profile-status busy pull-right"></span> </span>
                                                <div class="mail-contnet">
                                            ...
                                            <!-- Message -->
                                            <a href="javascript:void(0)" class="message-item">
                                                <span class="user-img"> <img src="dashboard/assets/images/users/3.jpg" alt="user" class="rounded-circle"> <span class="profile-status away pull-right"></span> </span>
                                                <div class="mail-contnet">
                                                    <h5 class="message-title">Arijit Sinh</h5> <span class="mail-desc">I am a singer!</span> <span class="time">9:08 AM</span> </div>
                                            </a>
                                            <!-- Message -->
                                            <a href="javascript:void(0)" class="message-item">
                                                <span class="user-img"> <img src="dashboard/assets/images/users/4.jpg" alt="user" class="rounded-circle"> <span class="profile-status offline pull-right"></span> </span>
                                                <div class="mail-contnet">
                        ...
                        <!-- User profile -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="dashboard/assets/images/users/1.jpg" alt="user" class="rounded-circle" width="31"></a>
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                <span class="with-arrow"><span class="bg-primary"></span></span>
                                <div class="d-flex no-block align-items-center p-15 bg-primary text-white mb-2">
                                    <div class=""><img src="dashboard/assets/images/users/1.jpg" alt="user" class="img-circle" width="60"></div>
                                    <div class="ml-2">
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li>
                            ...
                            <div class="user-profile d-flex no-block dropdown mt-3">
                                <div class="user-pic"><img src="dashboard/assets/images/users/1.jpg" alt="users" class="rounded-circle" width="40" /></div>
                        ...
                        <li class="nav-small-cap"><i class="mdi mdi-dots-horizontal"></i> <span class="hide-menu">My Universe</span></li>
                        <li class="sidebar-item"> <a class="sidebar-link" href="{{ url('/myuniverse') }}" aria-expanded="false"><i class="mdi mdi-home-variant"></i><span class="hide-menu">Home </span></a> 
                        </li>
                        <li class="nav-small-cap"><i class="mdi mdi-dots-horizontal"></i> <span class="hide-menu">My Project</span></li>
                        <li class="sidebar-item"> <a class="sidebar-link" href="ads" aria-expanded="false"><i class="mdi mdi-plus"></i><span class="hide-menu">Add Project </span></a> 
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link" href="asd" aria-expanded="false"><i class="mdi mdi-pencil"></i><span class="hide-menu">Edit Project </span></a> 
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link" href="asd" aria-expanded="false"><i class="mdi mdi-delete"></i><span class="hide-menu">Delete Project </span></a> 
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link" href="asd" aria-expanded="false"><i class="mdi mdi-content-paste"></i><span class="hide-menu">Project Status </span></a> 
                        </li>
                    </ul>
                </nav>
            ...
            <div class="tab-content" id="pills-tabContent">
                        ...
                        <li>
                            <div class="message-center chat-scroll">
                                ...
                                <a href="javascript:void(0)" class="message-item" id='chat_user_5' data-user-id='5'>
                                    <span class="user-img"> <img src="dashboard/assets/images/users/5.jpg" alt="user" class="rounded-circle"> <span class="profile-status offline pull-right"></span> </span>
                                    <div class="mail-contnet">
                                ...
                                <a href="javascript:void(0)" class="message-item" id='chat_user_6' data-user-id='6'>
                                    <span class="user-img"> <img src="dashboard/assets/images/users/6.jpg" alt="user" class="rounded-circle"> <span class="profile-status offline pull-right"></span> </span>
                                    <div class="mail-contnet">
                                ...
                                <a href="javascript:void(0)" class="message-item" id='chat_user_7' data-user-id='7'>
                                    <span class="user-img"> <img src="dashboard/assets/images/users/7.jpg" alt="user" class="rounded-circle"> <span class="profile-status offline pull-right"></span> </span>
                                    <div class="mail-contnet">
                                        <h5 class="message-title">Pavan kumar</h5> <span class="mail-desc">Just see the my admin!</span> <span class="time">9:02 AM</span> </div>
                                </a>
                                <!-- Message -->
                                ...
                                <a href="javascript:void(0)" class="message-item" id='chat_user_8' data-user-id='8'>
                                    <span class="user-img"> <img src="dashboard/assets/images/users/8.jpg" alt="user" class="rounded-circle"> <span class="profile-status offline pull-right"></span> </span>
                                    <div class="mail-contnet">
                ...
                <div class="tab-pane fade p-15" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                    ...
                    <div class="steamline">
                        ...
                        <div class="sl-item">
                            <div class="sl-left"> <img class="rounded-circle" alt="user" src="dashboard/assets/images/users/2.jpg"> </div>
                            <div class="sl-right">
                        ...
                        <div class="sl-item">
                            <div class="sl-left"> <img class="rounded-circle" alt="user" src="dashboard/assets/images/users/1.jpg"> </div>
                            <div class="sl-right">
                        ...
                        <div class="sl-item">
                            <div class="sl-left"> <img class="rounded-circle" alt="user" src="dashboard/assets/images/users/4.jpg"> </div>
                            <div class="sl-right">
                                <div class="font-medium">Go to the Doctor <span class="sl-date">5 minutes ago</span></div>
                                <div class="desc">Contrary to popular belief</div>
                            </div>
                        ...
                        <div class="sl-item">
                            <div class="sl-left"> <img class="rounded-circle" alt="user" src="dashboard/assets/images/users/6.jpg"> </div>
                            <div class="sl-right">
                                <div><a href="javascript:void(0)">Stephen</a> <span class="sl-date">5 minutes ago</span></div>
                                <div class="desc">Approve meeting with tiger</div>
                            </div>
    ...
    <script src="dashboard/dist/js/app.init.js"></script>
